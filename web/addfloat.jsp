...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
        ...
        <title>Add floating Rate</title>
        <script>
            function validate1(){
                var duration=document.forms["addFloat"]["duration"].value;
               var Rate=document.forms["addFloat"]["Rate"].value;
  ...
  <li><a href="LoanApps">Loan Applications</a></li>
    ...
    <center>
        <form action="addfloat1" name="addFloat" onsubmit="return validate1();" method="post">
            Loan-Type:<br/>
