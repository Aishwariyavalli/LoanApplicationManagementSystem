...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
        ...
        <title>Edit floating rate</title>
         <script>
            function validate1(){
                var duration=document.forms["eFloat"]["duration"].value;
               var Rate=document.forms["eFloat"]["Rate"].value;
  ...
  <li><a href="LoanApps">Loan Applications</a></li>
   ...
   <% 
         Session session1 = HibernateUtil.getSessionFactory().openSession();
           ...
           session.setAttribute("float", id);
            Floating float1=(Floating)session1.createQuery("FROM Floating f where f.No=:No").setParameter("No", id).uniqueResult();
        //Floating f=(Floating)session.getAttribute("fixed");
          
    %>
     <center>
        <form action="editFloat1" name="eFloat" onsubmit="return validate1();" method="post">
             Loan-Type:<br/>
            ...
            <input type="text" name="duration" value=<% out.println(float1.getDuration()); %>/>
            <br/>
             Interest Rate: <br/>
            <input type="text" name="Rate" value=<% out.println(float1.getRate()); %>/>
            <br/><br/>
