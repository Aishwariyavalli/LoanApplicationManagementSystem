...
public class LoanMaster implements java.io.Serializable {
   ...
   private String IssueDate;
    ...
    public LoanMaster(Integer LoanId, Integer CID, String LoanType, Integer LoanTenure, Integer LoanAmount,String InterestType, String IssueDate, String MortgageDetails, String GuarantorName,String Address,Integer ContactNo, Integer ApprStatus){
        this.LoanId=LoanId;
        this.CID=CID;
