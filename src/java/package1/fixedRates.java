 ...
 * @author Aishw
 */
@WebServlet(name = "fixedRates", urlPatterns = {"/fixedRates"})
public class fixedRates extends HttpServlet {
...
"</script>");
           ...
           out.println("</tr>");
           List fixedRs=session.createQuery("From Fixed").list();
           out.println("<form action='addfix.jsp'>");
           for (Iterator iterator = fixedRs.iterator(); iterator.hasNext();){
               Fixed fix=(Fixed) iterator.next();
               out.println("<tr>");
          ...
          out.println("<input type='submit' value='Add'/>");
           out.println("<input type='submit' value='Remove' formaction='delfix'/>");
           out.println("<input type='submit' value='Change' formaction='editF.jsp'/>");
           out.println("<br/><br/>");
