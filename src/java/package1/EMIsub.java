 ...
 * @author Aishw
 */
@WebServlet(name = "EMIsub", urlPatterns = {"/EMIsub"})
public class EMIsub extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           Session session = HibernateUtil.getSessionFactory().openSession();
            ...
            emi1.setInterestAmount(interest);
            emi1.setTotalAmount(tot);
            session.save(emi1);
            tx.commit();
            response.sendRedirect("calcEMI1");
        }
    }
